...
public class PropertiesRendererTests extends AbstractTextRendererTests {
    ...
    @Test
    public void render_PropertyModelKey() {
        IDiagramModelArchimateObject dmo = TextRendererTests.createDiagramModelObject();
    ...
    @Test
    public void render_PropertyViewKey() {
        IDiagramModelArchimateObject dmo = TextRendererTests.createDiagramModelObject();
    ...
    @Test
    public void render_PropertyModelFolderKey() {
        IDiagramModelArchimateObject dmo = TextRendererTests.createDiagramModelObject();
    ...
    @Test
    public void render_PropertyViewFolderKey() {
        IDiagramModelArchimateObject dmo = TextRendererTests.createDiagramModelObject();
    ...
    @Test
    public void render_PropertySourceKey() {
    ...
    @Test
    public void render_PropertyTargetKey() {
        IDiagramModelArchimateConnection dmc = TextRendererTests.createDiagramModelConnection();
    ...
    @Test
    public void render_PropertyConnectedSourceKey() {
        IDiagramModelArchimateConnection dmc = TextRendererTests.createDiagramModelConnection();
    ...
    @Test
    public void render_PropertyConnectedTargetKey() {
        IDiagramModelArchimateConnection dmc = TextRendererTests.createDiagramModelConnection();
    ...
    @Test
    public void render_PropertiesView() {
        IDiagramModelArchimateObject dmo = TextRendererTests.createDiagramModelObject();
    ...
    @Test
    public void render_PropertiesValuesCustomList() {
        IDiagramModelArchimateObject dmo = TextRendererTests.createDiagramModelObject();
        assertEquals("concept_v3\nconcept_v4", renderer.render(dmo, "${properties:\n:k3}"));
    }
    
    @Test
    public void render_PropertiesValuesCustomList_Model() {
        IDiagramModelArchimateObject dmo = TextRendererTests.createDiagramModelObject();
        assertEquals("model_v3\nmodel_v4", renderer.render(dmo, "$model{properties:\n:k3}"));
    }

    @Test
    public void render_PropertiesValuesCustomList_View() {
        IDiagramModelArchimateObject dmo = TextRendererTests.createDiagramModelObject();
